...
class FyersSymbolService:
    ...
    def __init__(self, cache_path: str | None = None) -> None:
        if cache_path:
            ...
            self.cache_path = self.build_dated_cache_path()

    @staticmethod
    def build_dated_cache_path(
        as_of: date | None = None,
        base_dir: str = "data/symbols",
    ) -> Path:
        current_date = as_of or date.today()
        filename = f"{current_date.strftime('%Y%m%d')}_symbols.json"
        return Path(base_dir) / filename

    def set_cache_for_date(
        self,
        as_of: date | None = None,
        *,
        base_dir: str = "data/symbols",
    ...
    def _build_symbol_from_dict(
        self,
        kind: str,
        payload: dict,
    ) -> FyersBaseSymbol | None:
        if kind == "equity":
    ...
    def _map_exchange_code(raw_exchange: str) -> str:
        ...
        return mapping.get(raw_exchange, raw_exchange)
    ...
    def _map_segment_code(raw_segment: str) -> str:
        ...
        return mapping.get(raw_segment, raw_segment)
    ...
    def _matches_underlying(self, item: FyersBaseSymbol, underlying: str) -> bool:
        ...
        for text in candidates:
            normalized = self._normalize_underlying_text(text)
    ...
    def get_index_spot(
        ...
        *,
        use_cache_only: bool = True,
    ) -> FyersIndexSpotSymbol | None:
        symbols = self.load_cache() if use_cache_only else self.fetch_symbol_master()

        for item in symbols:
            if not isinstance(item, FyersIndexSpotSymbol):
                continue

            if self._matches_underlying(item, underlying):
                return item
    ...
    def get_futures_for_underlying(
        ...
        *,
        use_cache_only: bool = True,
    ) -> list[FyersFutureSymbol]:
        symbols = self.load_cache() if use_cache_only else self.fetch_symbol_master()

        results = [
            item
            for item in symbols
            if isinstance(item, FyersFutureSymbol)
            and self._matches_underlying(item, underlying)
        ]
    ...
    def get_options_for_underlying(
        ...
        *,
        use_cache_only: bool = True,
    ) -> list[FyersOptionSymbol]:
        symbols = self.load_cache() if use_cache_only else self.fetch_symbol_master()

        results = [
            item
            for item in symbols
            if isinstance(item, FyersOptionSymbol)
            and self._matches_underlying(item, underlying)
        ]
        return sorted(
            results,
            key=lambda item: (item.expiry_epoch, item.strike, item.option_type),
        )
    ...
    def get_ce_options(
        ...
        *,
        ...
        return [
            item
            for item in self.get_options_for_underlying(
                underlying,
    ...
    def get_expiry_list(
        ...
        *,
        ...
        if instrument_kind == "future":
            contracts = self.get_futures_for_underlying(
                underlying,
                use_cache_only=use_cache_only,
            )
        elif instrument_kind == "option":
            contracts = self.get_options_for_underlying(
                underlying,
                use_cache_only=use_cache_only,
            )
        else:
    ...
    def get_current_next_far_expiries(
        self,
        underlying: str,
        *,
        instrument_kind: str = "option",
    ...
    def get_futures_by_expiry(
        ...
        *,
        ...
        futures = self.get_futures_for_underlying(
            underlying,
            use_cache_only=use_cache_only,
        )
    ...
    def get_options_by_expiry(
        ...
        *,
        ...
        options = self.get_options_for_underlying(
            underlying,
            use_cache_only=use_cache_only,
        )
        return [item for item in options if item.expiry_epoch == expiry_epoch]

    def get_ce_options_by_expiry(
        self,
        underlying: str,
        expiry_epoch: int,
        *,
        ...
        return [
            item
            for item in self.get_options_by_expiry(
                underlying,
                expiry_epoch,
                use_cache_only=use_cache_only,
            )
    ...
    def get_current_next_far_expiry_dates(
        self,
        underlying: str,
        *,
        instrument_kind: str = "option",
        ...
        expiry_map = self.get_current_next_far_expiries(
            underlying,
            instrument_kind=instrument_kind,
            use_cache_only=use_cache_only,
        )
    ...
    def get_weekly_expiry_dates(
        ...
        *,
        ...
        expiries = self.get_weekly_expiries(
            underlying,
            instrument_kind=instrument_kind,
            use_cache_only=use_cache_only,
        )
    ...
    def get_current_weekly_expiry(
        ...
        *,
        ...
        weekly = self.get_weekly_expiries(
            underlying,
    ...
    def get_current_monthly_expiry(
        ...
        *,
        ...
        monthly = self.get_monthly_expiries(
            underlying,
            instrument_kind=instrument_kind,
            use_cache_only=use_cache_only,
        )
    ...
    def get_current_weekly_expiry_date(
        self,
        underlying: str,
        *,
        use_cache_only: bool = True,
    ...
    def get_next_weekly_expiry_date(
        self,
        underlying: str,
        *,
        use_cache_only: bool = True,
    ...
    def get_current_monthly_expiry_date(
        self,
        underlying: str,
        *,
        instrument_kind: str = "option",
        ...
        expiry = self.get_current_monthly_expiry(
            underlying,
            instrument_kind=instrument_kind,
            use_cache_only=use_cache_only,
        )
    ...
    def get_next_monthly_expiry_date(
        self,
        underlying: str,
        *,
        instrument_kind: str = "option",
    ...
    def get_current_weekly_options(
        self,
        underlying: str,
        *,
        use_cache_only: bool = True,
        ...
        if expiry is None:
            return []
        return self.get_options_by_expiry(
            underlying,
            expiry,
            use_cache_only=use_cache_only,
        )

    def get_next_weekly_options(
        self,
        underlying: str,
        *,
        use_cache_only: bool = True,
    ...
    def get_current_monthly_options(
        self,
        underlying: str,
        *,
        use_cache_only: bool = True,
    ...
    def get_current_monthly_futures(
        self,
        underlying: str,
        *,
        use_cache_only: bool = True,
        ...
        if expiry is None:
            return []
        return self.get_futures_by_expiry(
            underlying,
            expiry,
            use_cache_only=use_cache_only,
        )

    def get_next_monthly_futures(
        self,
        underlying: str,
        *,
        use_cache_only: bool = True,
    ...
    def get_current_weekly_ce_options(
        self,
        underlying: str,
        *,
        use_cache_only: bool = True,
        ...
        return [
            item
            for item in self.get_current_weekly_options(
                underlying,
                use_cache_only=use_cache_only,
            )
            if item.option_type == "CE"
    ...
    def get_current_weekly_pe_options(
        self,
        underlying: str,
        *,
        use_cache_only: bool = True,
    ...
    def get_next_weekly_ce_options(
        self,
        underlying: str,
        *,
        use_cache_only: bool = True,
        ...
        return [
            item
            for item in self.get_next_weekly_options(
                underlying,
                use_cache_only=use_cache_only,
            )
            if item.option_type == "CE"
    ...
    def get_next_weekly_pe_options(
        self,
        underlying: str,
        *,
        use_cache_only: bool = True,
    ...
    def get_current_monthly_ce_options(
        self,
        underlying: str,
        *,
        use_cache_only: bool = True,
        ...
        return [
            item
            for item in self.get_current_monthly_options(
                underlying,
                use_cache_only=use_cache_only,
            )
            if item.option_type == "CE"
    ...
    def get_current_monthly_pe_options(
        self,
        underlying: str,
        *,
        use_cache_only: bool = True,
    ...
    def get_next_monthly_ce_options(
        self,
        underlying: str,
        *,
        use_cache_only: bool = True,
        ...
        return [
            item
            for item in self.get_next_monthly_options(
                underlying,
                use_cache_only=use_cache_only,
            )
            if item.option_type == "CE"
    ...
    def get_next_monthly_pe_options(
        self,
        underlying: str,
        *,
        use_cache_only: bool = True,
    ...
    def get_atm_strike(
        ...
        *,
        ...
        options = (
            self.get_options_by_expiry(
                underlying,
                expiry_epoch,
                use_cache_only=use_cache_only,
            )
            if expiry_epoch is not None
            else self.get_options_for_underlying(
                underlying,
                use_cache_only=use_cache_only,
            )
        )
    ...
    def get_atm_option_pair(
        ...
        *,
        expiry_epoch: int | None = None,
        use_cache_only: bool = True,
    ) -> tuple[FyersOptionSymbol | None, FyersOptionSymbol | None]:
        if expiry_epoch is None:
            expiry_epoch = self.get_current_weekly_expiry(
                underlying,
                use_cache_only=use_cache_only,
            )
        ...
        ce_options = self.get_ce_options_by_expiry(
            underlying,
            expiry_epoch,
            use_cache_only=use_cache_only,
        )
        pe_options = self.get_pe_options_by_expiry(
            underlying,
            expiry_epoch,
            use_cache_only=use_cache_only,
        )
...
if __name__ == "__main__":
    ...
    try:
        ...
        all_symbols = service.ensure_daily_cache(
            exchanges=["NSE_CM", "BSE_CM", "NSE_FO", "BSE_FO"],
            force_refresh=False,
        )
        ...
        if sensex_spot is None:
            ...
            print(
                f"{sensex_spot.kind} | {sensex_spot.symbol} | {sensex_spot.display_name} | "
                f"{sensex_spot.exchange_code} | {sensex_spot.segment_code} | {sensex_spot.token}"
            )
        ...
        print(
            service.get_current_monthly_expiry_date(
                "SENSEX",
                instrument_kind="option",
                use_cache_only=True,
            )
        ...
        current_weekly_ce = service.get_current_weekly_ce_options(
            "SENSEX",
            use_cache_only=True,
        )
        ...
        for item in current_weekly_ce[:5]:
            print(
                f"CE | {item.symbol} | {item.display_name} | "
                f"expiry={service.format_expiry(item.expiry_epoch)} | strike={item.strike}"
            )

        print("\nCurrent weekly PE count: SENSEX")
        current_weekly_pe = service.get_current_weekly_pe_options(
            "SENSEX",
            use_cache_only=True,
        )
        ...
        for item in current_weekly_pe[:5]:
            print(
                f"PE | {item.symbol} | {item.display_name} | "
                f"expiry={service.format_expiry(item.expiry_epoch)} | strike={item.strike}"
            )

        print("\nCurrent monthly CE count: SENSEX")
        current_monthly_ce = service.get_current_monthly_ce_options(
            "SENSEX",
            use_cache_only=True,
        )
        ...
        current_monthly_pe = service.get_current_monthly_pe_options(
            "SENSEX",
            use_cache_only=True,
        )
        ...
        current_monthly_futures = service.get_current_monthly_futures(
            "SENSEX",
            use_cache_only=True,
        )
        for item in current_monthly_futures:
            print(
                f"{item.kind} | {item.symbol} | {item.display_name} | "
                f"expiry={service.format_expiry(item.expiry_epoch)}"
            )

        sensex_spot_price = 65050.0

        print("\nATM strike: SENSEX")
        atm_strike = service.get_atm_strike(
            "SENSEX",
            sensex_spot_price,
            use_cache_only=True,
        )
        ...
        print("\nATM CE / PE: SENSEX")
        atm_ce, atm_pe = service.get_atm_option_pair(
            "SENSEX",
            sensex_spot_price,
            use_cache_only=True,
        )
        if atm_ce:
            print(
                f"ATM CE | {atm_ce.symbol} | {atm_ce.display_name} | "
                f"expiry={service.format_expiry(atm_ce.expiry_epoch)} | strike={atm_ce.strike}"
            )
        if atm_pe:
            print(
                f"ATM PE | {atm_pe.symbol} | {atm_pe.display_name} | "
                f"expiry={service.format_expiry(atm_pe.expiry_epoch)} | strike={atm_pe.strike}"
            )

        print("\nOTM CE: SENSEX")
        for item in service.get_otm_ce_options(
            "SENSEX",
            sensex_spot_price,
            count=5,
            use_cache_only=True,
            ...
            print(
                f"OTM CE | {item.symbol} | {item.display_name} | "
                f"expiry={service.format_expiry(item.expiry_epoch)} | strike={item.strike}"
            )

        print("\nOTM PE: SENSEX")
        for item in service.get_otm_pe_options(
            "SENSEX",
            sensex_spot_price,
            count=5,
            use_cache_only=True,
            ...
            print(
                f"OTM PE | {item.symbol} | {item.display_name} | "
                f"expiry={service.format_expiry(item.expiry_epoch)} | strike={item.strike}"
            )

        print("\nITM CE: SENSEX")
        for item in service.get_itm_ce_options(
            "SENSEX",
            sensex_spot_price,
            count=5,
            use_cache_only=True,
            ...
            print(
                f"ITM CE | {item.symbol} | {item.display_name} | "
                f"expiry={service.format_expiry(item.expiry_epoch)} | strike={item.strike}"
            )

        print("\nITM PE: SENSEX")
        for item in service.get_itm_pe_options(
            "SENSEX",
            sensex_spot_price,
            count=5,
            use_cache_only=True,
            ...
            print(
                f"ITM PE | {item.symbol} | {item.display_name} | "
                f"expiry={service.format_expiry(item.expiry_epoch)} | strike={item.strike}"
            )
